...
public static class Utilities
{
    ...
    public static int ReadIntParameter(Dictionary<string, string> parameters, string key, int defaultValue, int minValue, int maxValue)
    {
    ...
    public static decimal ReadDecimalParameter(Dictionary<string, string> parameters, string key, decimal defaultValue, decimal minValue, decimal maxValue)
    {
        if (parameters.TryGetValue(key, out var value) && decimal.TryParse(value, out var decimalValue))
        {
    ...
    public static string ReadStringParameter(Dictionary<string, string> parameters, string key, string defaultValue)
    {
    ...
    public static bool ReadBoolParameter(Dictionary<string, string> parameters, string key, bool defaultValue)
    {
    ...
    public static T ReadEnumParameter<T>(Dictionary<string, string> parameters, string key, T defaultValue) where T : struct
    {
